...
- Спека: [aapanel-manager-app-design](superpowers/specs/2026-06-08-aapanel-manager-app-design.md) · [версии/обновления + самообновление](superpowers/specs/2026-06-13-version-updates-design.md)
...
- Страница сервера: `web/src/app/(app)/servers/[id]/` (Обзор · Проекты — CRUD + выбор команды запуска из `package.json` · Базы данных) · экшены `web/src/server/actions/{projects,databases}.ts`
