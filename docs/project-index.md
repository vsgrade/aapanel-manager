...
│   ├── ru/{overview,authentication,nodejs-projects,sites,databases,system-monitoring}.md
│   └── en/{overview,authentication,nodejs-projects,sites,databases,system-monitoring}.md
└── examples/
    └── javascript/
